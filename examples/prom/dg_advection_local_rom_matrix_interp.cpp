...
int main(int argc, char *argv[])
{
    ...
    if (online)
    {
        ...
        else
        {
            ...
            CAROM::MatrixInterpolater basis_interpolater(parameter_points, rotation_matrices, bases, ref_point, "B", rbf_inv_width);
            CAROM::MatrixInterpolater M_interpolater(parameter_points, rotation_matrices, M_hats, ref_point, "SPD", rbf_inv_width);
            CAROM::MatrixInterpolater K_interpolater(parameter_points, rotation_matrices, K_hats, ref_point, "R", rbf_inv_width);
            CAROM::VectorInterpolater b_interpolater(parameter_points, rotation_matrices, b_hats, ref_point, rbf_inv_width);
            CAROM::VectorInterpolater u_init_interpolater(parameter_points, rotation_matrices, u_init_hats, ref_point, rbf_inv_width);
