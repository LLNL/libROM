...
//
// Compile with: make dg_advection_matrix_interpolation
//
// For ROM (reproductive case):
//    dg_advection_matrix_interpolation -offline
//    dg_advection_matrix_interpolation -online
//
// For ROM (parametric case using matrix interpolation):
//    dg_advection_matrix_interpolation -offline -ff 1.02
//    dg_advection_matrix_interpolation -online -ff 1.02 -tf 3.0 -rdim 20
//    dg_advection_matrix_interpolation -offline -ff 1.03
//    dg_advection_matrix_interpolation -online -ff 1.03 -tf 3.0 -rdim 20
//    dg_advection_matrix_interpolation -offline -ff 1.04
//    dg_advection_matrix_interpolation -online -ff 1.04 -tf 3.0 -rdim 20
//    dg_advection_matrix_interpolation -offline -ff 1.06
//    dg_advection_matrix_interpolation -online -ff 1.06 -tf 3.0 -rdim 20
//    dg_advection_matrix_interpolation -offline -ff 1.07
//    dg_advection_matrix_interpolation -online -ff 1.07 -tf 3.0 -rdim 20
//    dg_advection_matrix_interpolation -offline -ff 1.08
//    dg_advection_matrix_interpolation -online -ff 1.08 -tf 3.0 -rdim 20
//    dg_advection_matrix_interpolation -fom -ff 1.05 -tf 3.0
//    dg_advection_matrix_interpolation -online -ff 1.05 -tf 3.0 -interpolate -rdim 20

// Sample runs:
//    mpirun -np 4 dg_advection_matrix_interpolation -p 0 -dt 0.005
//    mpirun -np 4 dg_advection_matrix_interpolation -p 0 -dt 0.01
//    mpirun -np 4 dg_advection_matrix_interpolation -p 1 -dt 0.005 -tf 9
//    mpirun -np 4 dg_advection_matrix_interpolation -p 1 -rp 1 -dt 0.002 -tf 9
//    mpirun -np 4 dg_advection_matrix_interpolation -p 1 -rp 1 -dt 0.02 -s 13 -tf 9
//    mpirun -np 4 dg_advection_matrix_interpolation -p 1 -rp 1 -dt 0.004 -tf 9
//    mpirun -np 4 dg_advection_matrix_interpolation -p 1 -rp 1 -dt 0.005 -tf 9
//    mpirun -np 4 dg_advection_matrix_interpolation -p 3 -rp 2 -dt 0.0025 -tf 9 -vs 20
//    mpirun -np 4 dg_advection_matrix_interpolation -p 0 -o 2 -rp 1 -dt 0.01 -tf 8
//    mpirun -np 4 dg_advection_matrix_interpolation -p 0 -rs 2 -dt 0.005 -tf 2
//    mpirun -np 4 dg_advection_matrix_interpolation -p 0 -rs 1 -o 2 -tf 2
//    mpirun -np 3 dg_advection_matrix_interpolation -p 1 -rs 1 -rp 0 -dt 0.005 -tf 0.5
//
...
int main(int argc, char *argv[])
{
...

    {
        ...
        mesh_name << "dg_advection_matrix_interpolation-mesh." << setfill('0') << setw(6) << myid;
        sol_name << "dg_advection_matrix_interpolation-init." << setfill('0') << setw(6) << myid;
    ...
    if (adios2)
    {
        ...
        const std::string collection_name = "dg_advection_matrix_interpolation-p-" + postfix + ".bp";
    ...
    if (online)
    {
        ...
        solution_filename << "dg_advection_matrix_interpolation-final." << f_factor << "." << setfill('0') << setw(6) << myid;
    ...
    //     using GLVis: "glvis -np <np> -m dg_advection_matrix_interpolation-mesh -g dg_advection_matrix_interpolation-final".
    if (offline || fom)
    {
        *u = *U;
        ostringstream sol_name;
        sol_name << "dg_advection_matrix_interpolation-final." << f_factor << "." << setfill('0') << setw(6) << myid;
        ofstream osol(sol_name.str().c_str());
        osol.precision(precision);
