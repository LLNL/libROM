The gLaSDI framework is applied to construct a non-intrusive reduced-order model of the [**MFEM Example 16 Time-Dependent Radial Advection**](https://github.com/mfem/mfem/blob/master/examples/ex9.cpp).
