...
./solutionComparator ${GITHUB_WORKSPACE}/build/examples/prom/sol ${GITHUB_WORKSPACE}/dependencies/libROM/build/examples/prom/sol_f-0.01_fom "1.0e-5" "1" >> simulationLogFile-poisson.log 2>&1
