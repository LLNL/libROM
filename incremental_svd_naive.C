...
incremental_svd_naive::incremental_svd_naive(
   int dim,
   double epsilon,
   bool skip_redundant,
...
void
incremental_svd_naive::increment(
   const double* u_in,
   double time)
{
...
void
incremental_svd_naive::addRedundantIncrement(
   const Matrix* A,
   const Matrix* sigma)
{
...
void
incremental_svd_naive::addNewIncrement(
   const Vector* j,
   const Matrix* A,
   Matrix* sigma)
{
